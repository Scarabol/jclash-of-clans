...
public class MessageFactory {
    ...
    static {
        ...
        messages.add(new Message(MESSAGE_TYPE_LOGIN_OK).addField(Field.LONG).addField(Field.LONG).addField(Field.STRING)
                ...
                .addField(Field.INT).addField(Field.STRING).addField(Field.INT).addField(Field.INT).addField(Field.INT)
                .addField(Field.STRING).addField(Field.STRING).addField(Field.STRING).addField(Field.INT)
                .addField(Field.STRING).addField(Field.STRING));

        messages.add(new Message(MESSAGE_TYPE_OWN_HOME_DATA).addField(Field.INT).addField(Field.INT)
                .addField(Field.LONG).addField(Field.LONG).addField(Field.INT).addField(Field.LONG).addField(Field.BYTE)
                .addField(Field.STRING).addField(Field.INT).addField(Field.LONG).addField(Field.LONG)
                .addField(Field.BYTE).addField(Field.LONG).addField(Field.STRING).addField(Field.INT)
                .addField(Field.INT).addField(Field.INT).addField(Field.INT).addField(Field.LONG).addField(Field.BYTE)
                .addField(Field.INT).addField(Field.INT).addField(Field.INT).addField(Field.INT).addField(Field.STRING)
