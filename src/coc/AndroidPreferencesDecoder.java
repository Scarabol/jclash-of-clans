...
public class AndroidPreferencesDecoder {
     ...
     * 
     * @param key
     *            Encoder key. android_id or package name ()
     */
    public AndroidPreferencesDecoder(String key) {
        ...
        try {
            ...
            System.arraycopy("fldsjfodasjifudslfjdsaofshaufihadsf".getBytes(), 0, arrayOfByte, 0,
                    this.b.getBlockSize());
    ...
    public String decode(byte[] data, Cipher cipher) {
        try {
            ...
            // Logger.getLogger(AndroidPreferencesDecoder.class.getName()).log(Level.SEVERE,
            // null, ex);
